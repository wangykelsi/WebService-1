...
namespace WebService.DataMethod
{
    public class PsLabTest
    {
        ...
        public static int SetData(DataConnection pclsCache, string UserId, string VisitId, int SortNo, string LabItemType, string LabItemCode, string LabTestDate, string Status, string ReportDate, string DeptCode, string revUserId, string TerminalName, string TerminalIP, int DeviceType)
        {
            int ret = 0;
            try
            {
